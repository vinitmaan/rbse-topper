...
# ==========================================
# 2. MINIMALIST SaaS CSS (Like ChatGPT)
# ==========================================
st.markdown("""
    <style>
...
with st.sidebar:
    ...
    try:
        ...
        st.markdown("<h3 style='color: #111827; font-weight: 600; margin-bottom: 30px;'>💠 HEXALOY</h3>", unsafe_allow_html=True)
